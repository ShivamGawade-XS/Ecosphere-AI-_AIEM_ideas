...
describe("buildAnomalyRecommendation", () => {
  ...
  it("uses only supplied persisted quality, forecast, and carbon-factor evidence for its disclosed impact", () => {
    ...
    expect(recommendation.evidence).toMatchObject({ qualityStatuses: ["passed", "warning"], forecast: { id: 44, status: "ready" }, scenario: { id: 91, name: "HVAC controls option", carbonReductionKg: 886 } });
